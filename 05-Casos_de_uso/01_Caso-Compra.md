...
15. El sistema válida los datos.
16. El sistema válida correctamente y visualiza los cambios en el listado. 
...
2. Stock de productos actualizado según cantidades ingresadas. 
...
5. Filtrado de compras funciona correctamente según criterios.
...
4. El administrador intenta modificar la compra con datos que no cumplen las reglas de validación (cantidad negativa, producto inexistente, etc.)
5. El listado de compras no se actualiza correctamente o no muestra los registros debido a algún error en la consulta o filtrado.
