...
# Precondiciones: ...
# Caminos Básico:
1. El administrador ingresa a la pantalla cliente con antigüedad.
...
5. El administrador rellena los datos (nombre, CUIT/CUIL, teléfono, email).
...
12. El sistema guarda los datos y muestra mensaje de éxito. 
